...
const dummyApps: App[] = [
  ...
  },
  {
    id: 'mirror',
    name: 'Mirror.xyz',
    description: 'A decentralized publishing platform for writers and creators. Mint, collect, and discover Web3 articles.',
    logo: 'https://mirror.xyz/favicon.ico',
    category: 'social',
    isVerified: true,
    rating: 4.5,
    easyConnect: true,
  ...
  },
  {
    ...
    description: 'Decentralized naming for wallets, websites, & more. Register and manage .eth names.',
    logo: 'https://app.ens.domains/favicon.ico',
    category: 'utility',
    isVerified: true,
    rating: 4.6,
    easyConnect: true,
